    ...
    return (
        <div className="space-y-8">
            ...
            <Card className="rounded-xl border-transparent bg-muted/40 shadow-none">
                ...
                <CardContent>
                    <div className="h-[400px] rounded-lg border border-border/60">
            ...
            <Card className="rounded-xl border-transparent bg-muted/40 shadow-none">
                ...
                <CardContent>
                    <div className="h-[300px] rounded-lg border border-border/60">
                        <SplitPane split="vertical" defaultSize={300} minWidth={150} maxWidth={500} onChange={setSize1}>
                            <div className="h-full p-4 bg-muted/30">
                                <p className="font-medium">Constrained Pane</p>
                                <p className="text-sm text-muted-foreground mt-1">Min Width: 150px, Max Width: 500px</p>
                                <p className="text-sm text-muted-foreground mt-1">
                                    Current:{' '}
                                    <code className="rounded bg-muted px-1 py-0.5 font-mono text-sm">
                                        {Math.round(size1)}px
            ...
            <Card className="rounded-xl border-transparent bg-muted/40 shadow-none">
                ...
                <CardContent>
                    <div className="h-[500px] rounded-lg border border-border/60">
