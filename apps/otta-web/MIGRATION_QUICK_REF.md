...
- Route: `apps/otta-web/worker/routes/ottaorm-init.ts`
- Uses: `getAllSchemas()` helper to combine core + app + package tables
- Helper: `apps/otta-web/ottabase/db/schemas-helper.ts`
...
- Configured via: `/home/user/ottabase/apps/otta-web/ottabase/config.migrations.ts`
- Registry includes:
...
- Location: `/home/user/ottabase/apps/otta-web/ottabase/models/`
...
**Location:** `/home/user/ottabase/apps/otta-web/ottabase/models/Todo.ts`
