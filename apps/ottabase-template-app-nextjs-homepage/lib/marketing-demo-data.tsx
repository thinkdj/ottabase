/**
 * Shared demo data for all marketing pages.
 * Used by the homepage (app/page.tsx) and theme preview pages.
 */

import { Cloud, Code2, Gauge, Globe, Layers, Shield } from 'lucide-react';

export const demoNavbar = {
    brand: { name: 'Ottabase', href: '/' },
    links: [
