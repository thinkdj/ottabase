        ...
        <div className="mx-auto w-full max-w-5xl space-y-8 px-6 py-12">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <h1 className="text-3xl font-semibold tracking-tight">shadcn/ui Component Library</h1>
                </div>
                <p className="max-w-3xl text-muted-foreground">
                    Comprehensive showcase of all shadcn/ui components available in <code>@ottabase/ui-shadcn</code>.
                    Each component is fully themed and ready to use.
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Displays a menu to the user when right-clicking</CardDescription>
                </CardHeader>
                <CardContent>
                    <ContextMenu>
                        ...
                        <ContextMenuContent className="w-64">
                            ...
                            <ContextMenuItem inset>
                                Reload
                                <span className="ml-auto text-xs tracking-widest opacity-60">⌘R</span>
                            </ContextMenuItem>
                        </ContextMenuContent>
                    </ContextMenu>
                </CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A window overlaid on either the primary window or another dialog</CardDescription>
                </CardHeader>
                <CardContent>
                    <Dialog>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Displays a menu to the user when clicking a trigger</CardDescription>
                </CardHeader>
                <CardContent>
                    <DropdownMenu>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A state to display when there is no content to show</CardDescription>
                </CardHeader>
                <CardContent>
                    <Empty>
                        <EmptyIcon>
