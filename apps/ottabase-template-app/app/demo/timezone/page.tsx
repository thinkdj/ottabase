        ...
        <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-8 px-4 py-16">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-lg text-muted-foreground">
                    Production-ready timezone standardization for SaaS applications. Always store in UTC, display in
                    user's timezone.
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Automatically detect user's timezone from browser</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium">Change Timezone (Select from common timezones)</label>
                        <select
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        See current time in UTC (for database) and user's timezone (for display)
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="rounded-lg border bg-muted/50 p-4">
                            <h3 className="mb-2 text-sm font-medium text-muted-foreground">UTC (Database Format)</h3>
                        ...
                        <div className="rounded-lg border bg-blue-50 p-4 dark:bg-blue-950/30">
                            <h3 className="mb-2 text-sm font-medium">{selectedTimezone} (User Display)</h3>
                            <div className="space-y-1">
                                <p className="font-mono text-2xl font-bold">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Convert user input to UTC before storing in database</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="rounded-lg bg-muted p-4">
                        <div className="mb-4">
                            ...
                            <p className="text-sm">
                                User enters: <strong>"2024-01-15 2:30 PM"</strong> in their timezone ({selectedTimezone}
                                )
                            </p>
                        </div>
...
// Store dbRecord in database`}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Convert UTC dates to user's timezone for display</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="rounded-lg bg-muted p-4">
                        <div className="mb-4">
                            <h4 className="mb-2 text-sm font-semibold">Scenario:</h4>
                            <p className="text-sm">
                                Database contains UTC date: <strong>{exampleDates.utcDate.toISOString()}</strong>
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="rounded bg-green-50 p-3 dark:bg-green-950/30">
                                ...
                                <code className="text-sm">{exampleDates.utcDate.toISOString()}</code>
                            </div>

                            <div className="text-center">↓ formatInUserTimezone(date, 'PPpp')</div>

                            <div className="rounded bg-blue-50 p-3 dark:bg-blue-950/30">
                                <p className="mb-1 text-xs font-medium">Display to User ({selectedTimezone}):</p>
                                <code className="text-sm">
                    ...
                    <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4 dark:border-blue-900 dark:bg-blue-950/30">
                        ...
                        <div className="space-y-1 text-xs">
                            ...
                            <div className="flex justify-between">
                                <span>With TZ:</span>
                                <code className="rounded bg-background px-2 py-0.5">
                                    {formatInUserTimezone(exampleDates.utcDate, 'PPpp zzz', selectedTimezone)}
                                </code>
                            </div>
                        </div>
                    </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Convert dates between different timezones (e.g., for team collaboration)
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="rounded-lg bg-muted p-4">
                        ...
                        <div className="grid gap-3">
                            {[
                                ...
                                >
                                    ...
                                    <code className="text-sm">
                                        {formatInUserTimezone(exampleDates.scheduledDate, 'PPpp zzz', tz)}
                                    </code>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="mt-4 rounded border border-orange-200 bg-orange-50/50 p-3 dark:border-orange-900 dark:bg-orange-950/30">
                            <p className="text-xs">
                                <strong>Note:</strong> Daylight Saving Time is automatically handled. June 15 shows DST
                                offsets for applicable timezones.
                            </p>
                        </div>
                    </div>
                </CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Ready-to-use format presets for common display patterns - no need to remember format strings!
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="rounded-lg bg-muted p-4">
                        ...
                        <div className="space-y-3">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-mono text-sm">
                                            {formatShortDateTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <code className="text-xs">formatDayMonthDateTime()</code>
                                        <span className="font-mono text-sm">
                                            {formatDayMonthDateTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <code className="text-xs">formatLongDateTime()</code>
                                        <span className="font-mono text-sm">
                                            {formatLongDateTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <code className="text-xs">formatISODateTime()</code>
                                        <span className="font-mono text-sm">
                                            {formatISODateTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <code className="text-xs">formatCompactDateTime()</code>
                                        <span className="font-mono text-sm">
                                            {formatCompactDateTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <code className="text-xs">formatDateAtTime()</code>
                                        <span className="font-mono text-sm">
                                            {formatDateAtTime(exampleDates.utcDate, selectedTimezone)}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded border bg-background p-3">
                                <div className="mb-1 text-xs font-medium text-muted-foreground">Date Only Formats</div>
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                            ...
                            <div className="rounded border bg-background p-3">
                                <div className="mb-1 text-xs font-medium text-muted-foreground">Time Only Formats</div>
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Common patterns for using timezone utilities in your app</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        <div>
                            <h4 className="mb-2 text-sm font-semibold">🔧 Configuration (App Initialization)</h4>
...
setTimezoneConfig({ userTimezone: user.timezone });`}
                        ...
                        <div>
                            <h4 className="mb-2 text-sm font-semibold">💾 Saving to Database</h4>
                            <code className="block whitespace-pre-wrap rounded bg-muted p-3 text-xs">
...
const newPost = await db.post.create({
  data: {
    ...
    publishAt: toUTC(userInput, user.timezone), // Convert user input
                        ...
                        <div>
                            <h4 className="mb-2 text-sm font-semibold">📺 Displaying to User (Custom Format)</h4>
                            <code className="block whitespace-pre-wrap rounded bg-muted p-3 text-xs">
...
const formatted = posts.map(post => ({
  ...
  createdAtDisplay: formatInUserTimezone(
    ...
    user.timezone
                        ...
                        <div>
                            <h4 className="mb-2 text-sm font-semibold">🎨 Displaying with Preset Formats</h4>
                            <code className="block whitespace-pre-wrap rounded bg-muted p-3 text-xs">
...
const formatted = posts.map(post => ({
  ...
  scheduledDisplay: formatDateAtTime(post.scheduledAt, user.timezone),
                        ...
                        <div>
                            <h4 className="mb-2 text-sm font-semibold">🌍 Timezone Selector</h4>
                            <code className="block whitespace-pre-wrap rounded bg-muted p-3 text-xs">
  ...
  await db.user.update({
    ...
    data: { timezone: selectedTimezone },
            ...
            <div className="rounded-lg border bg-muted/50 p-6">
                <h2 className="mb-4 text-xl font-semibold">@ottabase/utils/timezone Package</h2>
                <div className="space-y-3 text-sm">
                    <div className="flex items-start gap-2">
                        <span className="font-medium">📦 Installation:</span>
                        <code className="rounded bg-background px-2 py-1">Already included in @ottabase/utils</code>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <span>Production SaaS apps needing standardized timezone handling</span>
                    </div>
                    <div className="flex items-start gap-2">
                        <span className="font-medium">✅ Features:</span>
                        <span>UTC storage, user timezone display, auto-detection, DST support, type-safe</span>
                    </div>
                </div>
            </div>
        </div>
