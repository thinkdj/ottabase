    ...
    return (
        <div className="min-h-screen bg-[#FBFBFA] p-8">
            <div className="mx-auto max-w-2xl">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-semibold text-gray-900">D1 Database Demo</h1>
                    <p className="text-gray-600">Full CRUD operations with Cloudflare D1 SQLite database</p>
                </div>
                ...
                <div className="mt-8 rounded-lg border border-gray-200 bg-white p-6">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                        <li>
                            ✅ Uses <strong>Prisma ORM</strong> with D1 adapter for type-safe queries
                        </li>
                        ...
                        <li>
                            📚 See{' '}
                            <a
                                href="https://github.com/yourusername/ottabase/blob/main/docs/D1_LOCAL_DEVELOPMENT.md"
                                className="text-blue-600 hover:underline"
                            >
                                D1 Local Development Guide
                            </a>
                        </li>
                    </ul>
                </div>
