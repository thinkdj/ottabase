    ...
    return (
        <div className="min-h-screen bg-[#FBFBFA] p-8">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-semibold text-gray-900">Realtime Pub/Sub Demo</h1>
                    <p className="text-gray-600">WebSocket-based real-time messaging with offline support</p>
                </div>

                <div className="mb-6 rounded-lg border border-red-200 bg-red-50 p-4">
                    <h3 className="mb-2 text-sm font-medium text-red-900">❌ Local Development Not Supported</h3>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="mb-2 block text-sm font-medium text-gray-900">Event Name</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="mb-2 block text-sm font-medium text-gray-900">Data (JSON)</label>
                                    <textarea
                                        value={broadcastData}
                                ...
                                <label className="flex items-center gap-2">
                                    ...
                                    />
                                    <span className="text-sm text-gray-700">Persist for offline clients</span>
                                </label>
                    ...
                    <div className="space-y-6">
                        {/* Messages */}
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <h2 className="mb-4 text-lg font-medium text-gray-900">Messages ({messages.length})</h2>

                            <div className="max-h-96 space-y-2 overflow-y-auto">
                                {messages.length === 0 ? (
                                    <p className="text-center text-sm text-gray-500 py-8">
                                        No messages yet. Subscribe to a channel and broadcast a message to see them
                                        here.
                                    </p>
                                ) : (
                                    messages.map((msg) => (
                                        ...
                                        >
                                            <div className="mb-1 flex items-center justify-between">
                                                <span className="text-xs font-medium text-gray-600">{msg.channel}</span>
                                                <span className="text-xs text-gray-500">
                                                    {new Date(msg.timestamp).toLocaleTimeString()}
                                                </span>
                                            </div>
                                            <p className="mb-1 text-sm font-medium text-gray-900">{msg.event}</p>
                        ...
                        {/* Stats */}
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <h2 className="mb-4 text-lg font-medium text-gray-900">System Stats</h2>

                            {stats ? (
                                <div className="space-y-3">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-600">Total Connections:</span>
                                        <span className="font-medium text-gray-900">{stats.totalConnections}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-600">Active Channels:</span>
                                        <span className="font-medium text-gray-900">{stats.channels.length}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-600">Offline Messages:</span>
                                        <span className="font-medium text-gray-900">{stats.offlineMessagesQueued}</span>
                                    </div>

                                    {stats.channels.length > 0 && (
                                        <div className="mt-4">
                                            <p className="mb-2 text-sm font-medium text-gray-700">Channel Details:</p>
