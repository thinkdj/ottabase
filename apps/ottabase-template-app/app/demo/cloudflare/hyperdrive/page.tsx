    ...
    return (
        <div className="min-h-screen bg-[#FBFBFA] p-8">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-semibold text-gray-900">Hyperdrive Demo</h1>
                ...
                <div className="mb-8 rounded-lg border border-yellow-200 bg-yellow-50 p-6">
                    <h3 className="mb-3 text-sm font-medium text-yellow-900">☁️ Production-Only Feature</h3>
                    <p className="mb-4 text-sm text-yellow-700">
                        <strong>Hyperdrive requires deployment to Cloudflare Workers.</strong> It accelerates
                        connections to remote databases (PostgreSQL, MySQL) using Cloudflare's connection pooling
                        infrastructure. Local development should connect directly to your database. Hyperdrive works
                        with:
                    </p>
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-4 text-sm font-medium text-gray-900">Key Benefits</h3>
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="rounded-lg border border-gray-200 p-4">
                            <h4 className="mb-2 text-sm font-semibold text-gray-900">🚀 Connection Pooling</h4>
                            <p className="text-xs text-gray-600">
                                Reuses database connections across requests, eliminating the overhead of creating new
                                connections for every Worker invocation.
                            </p>
                        </div>

                        <div className="rounded-lg border border-gray-200 p-4">
                            <h4 className="mb-2 text-sm font-semibold text-gray-900">⚡ Query Caching</h4>
                            <p className="text-xs text-gray-600">
                                Automatically caches frequently-read queries at the edge, reducing latency and database
                                load.
                            </p>
                        </div>
                        ...
                        <div className="rounded-lg border border-gray-200 p-4">
                            ...
                            <p className="text-xs text-gray-600">
                                Smart routing ensures queries are routed through the optimal Cloudflare location closest
                                to your database.
                            </p>
                        </div>
                        ...
                        <div className="rounded-lg border border-gray-200 p-4">
                            ...
                            <p className="text-xs text-gray-600">
                                Connections to your database are encrypted. Credentials are stored securely and never
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Setup Instructions</h3>
...
wrangler hyperdrive create my-mysql \\
  --connection-string="mysql://user:password@host:3306/database"`}
                        ...
                        <div>
                            <p className="mb-2 text-sm font-semibold text-gray-900">2. Add binding to wrangler.jsonc</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
                                {`"hyperdrive": [
  {
    "binding": "HYPERDRIVE",
    "id": "your-hyperdrive-id-here"
                        ...
                        <div>
                            <p className="mb-2 text-sm font-semibold text-gray-900">3. Use in your Worker code</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({ users: result.rows });
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Usage with Popular ORMs</h3>

                    <div className="space-y-6">
                        <div>
                            <p className="mb-2 text-sm font-semibold text-gray-900">Drizzle ORM</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
export async function onRequest(context) {
  ...
  return new Response(JSON.stringify(users));
                        ...
                        <div>
                            <p className="mb-2 text-sm font-semibold text-gray-900">Node.js pg driver (PostgreSQL)</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
export async function onRequest(context) {
  ...
  return new Response(JSON.stringify(result.rows));
                        ...
                        <div>
                            <p className="mb-2 text-sm font-semibold text-gray-900">mysql2 driver (MySQL)</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
export async function onRequest(context) {
  ...
  return new Response(JSON.stringify(rows));
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Best Practices</h3>
                    <ul className="space-y-3 text-sm text-gray-600">
                        <li>
                            <span className="font-medium text-gray-900">• Connection Management:</span> Always close
                            connections after use. Hyperdrive pools connections, but you should still properly clean up
                            client connections.
                        </li>
                        <li>
                            <span className="font-medium text-gray-900">• Read vs Write:</span> Hyperdrive is optimized
                            for read-heavy workloads. Write queries still benefit from connection pooling but are not
                            cached.
                        </li>
                        <li>
                            <span className="font-medium text-gray-900">• Cache Control:</span> Use prepared statements
                            for frequently executed queries to maximize cache hit rates.
                        </li>
                        <li>
                            <span className="font-medium text-gray-900">• Regional Routing:</span> Create Hyperdrive
                            configurations in the same region as your database for lowest latency.
                        </li>
                        <li>
                            <span className="font-medium text-gray-900">• Error Handling:</span> Implement proper error
                            handling and retries for database operations.
                        </li>
                        <li>
                            <span className="font-medium text-gray-900">• Monitoring:</span> Use Cloudflare's analytics
                            to monitor Hyperdrive performance and cache hit rates.
                        </li>
                    </ul>
                </div>

                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Configuration Methods</h3>
...
if (result.success) {
  ...
  await client.end();
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Performance Comparison</h3>
                ...
                <div className="mt-8 rounded-lg border border-yellow-200 bg-yellow-50 p-6">
                    <h3 className="mb-3 text-sm font-medium text-yellow-900">Local Development Note</h3>
                    <p className="text-sm text-yellow-700">
                        Hyperdrive is not available in local development with{' '}
                        <code className="rounded bg-yellow-100 px-1">wrangler dev</code>. For local testing, you can:
                    </p>
                    <ul className="mt-2 space-y-1 text-sm text-yellow-700">
                        <li>• Use a direct database connection string in development</li>
                        <li>
                            • Use <code className="rounded bg-yellow-100 px-1">wrangler dev --remote</code> to test
                            against real Hyperdrive
                        </li>
