    ...
    return (
        <div className="min-h-screen bg-[#FBFBFA] p-8">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-semibold text-gray-900">Images Demo</h1>
                    <p className="text-gray-600">Image upload, transformation, and optimization</p>
                </div>

                <div className="mb-8 rounded-lg border border-yellow-200 bg-yellow-50 p-6">
                    <h3 className="mb-3 text-sm font-medium text-yellow-900">☁️ Cloud-Only Service</h3>
                    <p className="mb-4 text-sm text-yellow-700">
                        <strong>Cloudflare Images is a cloud-only service.</strong> It requires API authentication and
                        uploads go directly to Cloudflare (not local storage). To use Images in development:
                    </p>
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    ...
                    <div className="space-y-4 text-sm text-gray-600">
                        <div>
                            <p className="mb-2 font-medium text-gray-900">1. Add to your .env file:</p>
...
CF_API_TOKEN=your-api-token`}
                        ...
                        <div>
                            <p className="mb-2 font-medium text-gray-900">2. Initialize the Images client:</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
const images = createImagesClient({
  ...
  apiToken: process.env.CF_API_TOKEN!
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Usage Examples</h3>

                    <div className="space-y-6">
                        <div>
                            <p className="mb-2 text-sm font-medium text-gray-900">Upload an image</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
                                {`// Upload from file
...
if (result.success) {
  ...
  console.log('Variants:', result.data.variants);
                        ...
                        <div>
                            <p className="mb-2 text-sm font-medium text-gray-900">Get delivery URL</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
const customUrl = images.getDeliveryUrl(imageId, 'public', {
  ...
  fit: 'cover'
                        ...
                        <div>
                            <p className="mb-2 text-sm font-medium text-gray-900">Get image details</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
if (result.success) {
  ...
  console.log('Metadata:', result.data.metadata);
                        ...
                        <div>
                            <p className="mb-2 text-sm font-medium text-gray-900">List images</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
if (result.success) {
  ...
  console.log('Total:', result.data.total);
                        ...
                        <div>
                            <p className="mb-2 text-sm font-medium text-gray-900">Delete an image</p>
                            <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
...
if (result.success) {
  console.log('Image deleted successfully');
                ...
                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">Features</h3>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6">
                    <h3 className="mb-3 text-sm font-medium text-gray-900">API Route Example</h3>
                    <pre className="overflow-x-auto rounded bg-gray-50 p-4 text-xs">
