    ...
    return (
        <div className="min-h-screen bg-[#FBFBFA] p-8">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-semibold text-gray-900">Cloudflare Features</h1>
                ...
                <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
                    <h3 className="mb-2 text-sm font-medium text-blue-900">Setup Required</h3>
                    <p className="text-sm text-blue-700">
                        Make sure you&apos;ve configured your Cloudflare bindings in{' '}
                        <code className="rounded bg-blue-100 px-1 py-0.5">wrangler.jsonc</code>. See the{' '}
                        <Link href="/docs/cloudflare-features" className="font-medium underline">
                            documentation
                        </Link>{' '}
