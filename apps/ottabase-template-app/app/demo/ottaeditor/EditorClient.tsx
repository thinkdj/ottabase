  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        message:
          "Make sure to save your editor content before navigating away!",
      },
    },
    {
      type: "table",
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        type: "info",
        message:
          "This is a custom Alert plugin! Change the type dropdown above to see different styles.",
      },
    },
  ],
  version: "2.30.7",
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">
          OttaEditor Demo - New Plugin Configuration
        </h1>
        <p className="text-lg text-muted-foreground">
          Demonstrating the new typesafe plugin configuration system with two
    ...
    { name: 'alert', tool: CustomAlertPlugin }
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Using <code>defaultPlugins: &apos;all&apos;</code> - loads all 15
            default plugins
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            >
              💾 Save Editor 1
              {editor1.hasUnsavedChanges && (
                <span className="ml-2 text-xs">●</span>
              )}
            </Button>
            <Button
              onClick={() => editor1.clear()}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Using{" "}
            <code>
              defaultPlugins: [&apos;header&apos;, &apos;paragraph&apos;]
            </code>{" "}
            + custom Alert plugin
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            >
              💾 Save Editor 2
              {editor2.hasUnsavedChanges && (
                <span className="ml-2 text-xs">●</span>
              )}
            </Button>
            <Button
              onClick={() => editor2.clear()}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All these names have TypeScript autocomplete support
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={name}
                className="flex flex-col p-3 bg-slate-50 dark:bg-slate-900 rounded-lg"
              >
      ...
      <Card className="bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
        ...
        <CardContent>
          <ul className="space-y-2">
            <li>
              ✅ <strong>TypeScript Autocomplete</strong> - Plugin names have
              full IDE support
            </li>
            <li>
              ✅ <strong>&apos;all&apos; Option</strong> - Load all plugins with
              a single keyword
            </li>
            <li>
              ✅ <strong>Selective Loading</strong> - Pick only the plugins you
              need
            </li>
            <li>
              ✅ <strong>Easy Custom Plugins</strong> - Use{" "}
              <code>additionalPlugins</code> to add your own
            </li>
            <li>
              ✅ <strong>Unsaved Changes Detection</strong> -{" "}
              <code>hasUnsavedChanges</code> flag enables smart save buttons
            </li>
            <li>
