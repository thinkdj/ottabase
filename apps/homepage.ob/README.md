...
A standalone static landing page for the Ottabase open-source launch.
**No framework, no build step, no dependencies.** Pure HTML, CSS, and vanilla JS.
...
- **Dark theme** — `#09090b` background, violet `#8b5cf6` accent, amber `#f59e0b` secondary
...
All content is hardcoded in the HTML files. The package list lives in `packages.html`.
To update:
