        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-lg text-muted-foreground">
                    Production-ready timezone standardization for SaaS apps: store in UTC,
                    ...
                    <div className="rounded-lg bg-muted p-4">
                        <div className="grid gap-2 text-sm">
                            ...
                            <div className="flex justify-between gap-3">
                                ...
                                <code className="rounded bg-background px-2 py-1">
                                    {isDST(currentTime, userTimezone)
                                        ? "Yes (Summer)"
                                        : "No (Winter)"}
                                </code>
                            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Compare storage time (UTC) vs display time (user timezone)
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardContent className="space-y-4">
                    <div className="rounded-lg bg-muted p-4">
                        <div className="mb-4">
                            ...
                            <p className="text-sm">
                                User enters: <strong>"2024-01-15 2:30 PM"</strong> in timezone{" "}
                                ({selectedTimezone})
                            </p>
                        </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Convert stored UTC dates into user timezone for display
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="rounded-lg border bg-muted/50 p-4">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between gap-3">
                                    ...
                                    <code>
                                        {formatShortDateTime(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatLongDateTime</span>
                                    <code>
                                        {formatLongDateTime(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatISODateTime</span>
                                    <code>
                                        {formatISODateTime(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatShortDate</span>
                                    <code>
                                        {formatShortDate(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatSlashDate</span>
                                    <code>
                                        {formatSlashDate(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                ...
                                <div className="flex justify-between gap-3">
                                    ...
                                    <code>
                                        {formatTime12Hour(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatTime24Hour</span>
                                    <code>
                                        {formatTime24Hour(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                    <span className="text-muted-foreground">formatFullDate</span>
                                    <code>
                                        {formatFullDate(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                                <div className="flex justify-between gap-3">
                                ...
                                <div className="flex justify-between gap-3">
                                    ...
                                    <code>
                                        {formatDateAtTime(exampleDates.scheduledDate, selectedTimezone)}
                                    </code>
                                </div>
                            </div>
                        </div>
