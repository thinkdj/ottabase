        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {editor.isReady ? <Badge>Ready</Badge> : <Badge variant="secondary">Initializing...</Badge>}
                    </div>
                </CardTitle>
            ...
            <CardContent className="space-y-4">
                ...
                <div
                    ...
                    className="min-h-[300px] prose prose-slate dark:prose-invert max-w-none rounded-lg border p-4"
                />
                {savedData ? (
    ...
    return (
        <div className="space-y-8">
            ...
            <DemoEditor
                ...
                description={
                    <span>
                        Using <code>AdvancedImageTool</code> with{' '}
                        <strong>{uploadProvider === 'r2' ? 'R2' : 'CF Images'}</strong> provider.
                    </span>
                }
                config={{
                    defaultPlugins: 'all',
