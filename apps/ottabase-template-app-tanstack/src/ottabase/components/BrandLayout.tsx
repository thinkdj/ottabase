...
function SidebarNav() {
    ...
    return (
        <aside className="hidden md:flex w-56 shrink-0 flex-col border-r bg-sidebar-background min-h-[calc(100vh-57px)] sticky top-[57px] self-start">
    ...
    return (
        <div className="min-h-screen bg-background font-sans flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <main
                    className={`flex-1 mx-auto px-4 ${paddingClass} ${hasSidebar ? 'max-w-none w-full' : cwClass}`}
                >
                    <Outlet />
                </main>
            </div>
