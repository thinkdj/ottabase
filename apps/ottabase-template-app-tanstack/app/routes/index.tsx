    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="flex max-w-3xl flex-col items-center gap-8 px-4 text-center">
        ...
        <p className="text-lg leading-relaxed text-muted-foreground">
          A modern React app template built with <strong>TanStack Start</strong>,{" "}
          <strong>TypeScript</strong>, and <strong>Tailwind CSS</strong>.
          Optimized for Cloudflare Workers deployment with theme switching, 
          state management, and a scalable monorepo architecture.
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-2 justify-center">
          ...
          >
            <Link to="/demo/mantine">Mantine Demo</Link>
          </Button>

          <Button asChild variant="outline" size="lg">
            <Link to="/demo/shadcn">shadcn/ui Demo</Link>
          </Button>
