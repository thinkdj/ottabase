    ...
    <div className="mx-auto w-full max-w-5xl space-y-8 px-6 py-12">
        ...
        <CardContent>
          <HoverCard>
            <HoverCardTrigger asChild>
              <Button variant="link">@tanstack</Button>
            </HoverCardTrigger>
            <HoverCardContent className="w-80">
              <div className="flex justify-between space-x-4">
                <Avatar>
                  <AvatarImage src="https://github.com/tanstack.png" />
                  <AvatarFallback>TS</AvatarFallback>
                </Avatar>
                <div className="space-y-1">
                  <h4 className="text-sm font-semibold">@tanstack</h4>
                  <p className="text-sm">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Custom cross-browser scrolling
          </CardDescription>
        </CardHeader>
        <CardContent>
