/**
 * Email provider configuration and testing endpoints
 */
...
export function handleEmailProviders(env: CloudflareEnv): Response {
    const providers = {
        resend: {
...
export async function handleEmailTest(request: Request, env: CloudflareEnv): Promise<Response> {
