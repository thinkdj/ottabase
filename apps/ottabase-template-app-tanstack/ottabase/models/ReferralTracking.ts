// ============================================================
// ReferralTracking Model (App-specific implementation of @ottabase/referrals)
// ============================================================
 ...
 *
 * // Mark as completed
 * await tracking.markCompleted("referred-user-id");
 *
 * // Get stats for a user
 * const stats = await ReferralTracking.getStats("user-123");
 * ```
 */
