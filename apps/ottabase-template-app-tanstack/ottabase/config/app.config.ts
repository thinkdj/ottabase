...
export const appConfig = createAppConfig({
  appName: "Ottabase TanStack App",
  defaults: {
    meta: {
      author: "@thinkdj",
      description:
        "A template application built with Ottabase monorepo and TanStack Start - Cloudflare Workers optimized",
      keywords:
        "Ottabase, TanStack Start, Cloudflare Workers, Tailwind, Mantine, Shadcn, React, TypeScript, JavaScript",
