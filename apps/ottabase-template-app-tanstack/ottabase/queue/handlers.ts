 ...
 */
export const sendEmailHandler: JobHandler<SendEmailPayload, CloudflareEnv> = async (
  job,
  ctx
) => {
 ...
 */
export const processOrderHandler: JobHandler<
  ProcessOrderPayload,
  CloudflareEnv
> = async (job, ctx) => {
 ...
 */
export const generateReportHandler: JobHandler<
...
> = async (job, ctx) => {
  ...
  console.log(
    `[Queue:generate-report] Report ${reportType} generated successfully`
  );
};
 ...
 */
export const syncDataHandler: JobHandler<SyncDataPayload, CloudflareEnv> =
  async (job, ctx) => {
 ...
 */
export const batchTaskHandler: JobHandler<BatchTaskPayload, CloudflareEnv> =
  async (job, ctx) => {
