...
export type { OAuthProfile, OAuthProviderConfig, OAuthTokenResponse, ProviderEnv, ProviderOptions } from './providers/types';
 ...
 */
export function resolveMagicLinkSender(env: ProviderEnv, options: MagicLinkTemplateOptions = {}): MagicLinkSender | null {
