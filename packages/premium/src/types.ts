// ============================================================
// @ottabase/premium — the paid-package contract
// ============================================================
...
// Type-only, and deliberately circular: a paid package's routes almost always need to
...
/**
 * Runtime state of a registered paid package. Resolved on every request from the
 ...
 * every closed gate still leaves the host app fully functional: a paid package that
...
/** A nav entry a paid package contributes to the host's admin navigation. */
...
/**
 * A paid package, as declared by its vendor.
 *
...
export interface PremiumPackage<Env = unknown> {
    ...
    /** Features available WITHOUT a license — the free tier of a paid package. */
