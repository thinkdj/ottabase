...
function parseRecord(raw: string | null): PremiumInstallRecord | null {
    ...
    try {
        ...
        if (
            ...
            (record.license !== undefined && record.license !== null && typeof record.license !== 'string') ||
            (record.lastState !== undefined && typeof record.lastState !== 'string')
        ) {
            return null;
        }
        ...
        return {
            ...
            license: record.license as string | null | undefined,
            lastState: record.lastState as PremiumInstallRecord['lastState'],
        };
    } catch {
