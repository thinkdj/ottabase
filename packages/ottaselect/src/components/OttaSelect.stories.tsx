...
export const SingleSelectBasic: Story = {
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: '20px', padding: '10px', background: '#f5f5f5', borderRadius: '4px' }}>
          ...
          <pre style={{ margin: 0, fontSize: '11px', fontFamily: 'monospace', maxHeight: '200px', overflow: 'auto' }}>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Input: Objects with {id, name, ...any properties}. Output: Original object with normalized id and name.',
      },
    },
  },
};
...
export const FlexibleInputWithLabel: Story = {
  ...
  render: () => {
    ...
    return (
      <div>
        <div style={{ marginBottom: '12px', padding: '8px', background: '#e3f2fd', borderRadius: '4px', fontSize: '12px' }}>
...
export const MultiSelectBasic: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Multi-select returns array of objects with all original properties, or null when empty',
      },
    },
  },
};
...
export const WithAsyncFetch: Story = {
  ...
  render: () => {
    ...
    return (
      <div>
        <div style={{ marginBottom: '12px', padding: '8px', background: '#fff3cd', borderRadius: '4px', fontSize: '12px' }}>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'fetchCollection can return any object format. Component normalizes id and name while preserving all properties.',
      },
    },
  },
};
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
        <div>
          ...
          <div style={{ marginTop: '10px', padding: '10px', background: '#f5f5f5', borderRadius: '4px' }}>
            <pre style={{ margin: 0, fontSize: '10px', fontFamily: 'monospace', maxHeight: '120px', overflow: 'auto' }}>
