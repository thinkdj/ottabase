...
export function buildBlogRouter<Env = unknown>(
    ...
    r.post('/photo-journals', (c) => handlers.handleBlogPhotoJournalCreate(ctxOf(c)));
    r.patch('/photo-journals/:postId', (c) => handlers.handleBlogPhotoJournalUpdate(ctxOf(c), c.params.postId));
