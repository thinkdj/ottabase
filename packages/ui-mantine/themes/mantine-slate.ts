            ...
            styles: (theme: any) =>
                ({
                    ...
                    filled: {
                        ...
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[6] : theme.colors.slate[8],
                        },
                        '&:active': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[5] : theme.colors.slate[9],
                        },
                    },
                    outline: {
                        ...
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[8] : theme.colors.slate[1],
                            color: 'var(--mantine-color-text)',
                        },
                    },
                    subtle: {
                    ...
                    light: {
                        ...
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[7] : theme.colors.slate[2],
                        },
                    },
                ...
                ({
                    radio: {
                        ...
                        '&:checked': {
                            ...
                            '&::before': {
                                backgroundColor:
                                    theme.colorScheme === 'dark' ? theme.colors.slate[3] : theme.colors.slate[9],
                                width: '0.375rem',
                                height: '0.375rem',
                                borderRadius: '50%',
                                content: '""',
            ...
            styles: (theme: any) =>
                ({
                    track: {
                        ...
                        '&[dataChecked]': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[4] : theme.colors.slate[9],
                        },
                    },
                    thumb: {
            ...
            styles: (theme: any) =>
                ({
                    ...
                    tr: {
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.slate[8] : theme.colors.slate[0],
                        },
                    },
                }) as Record<string, React.CSSProperties>,
        },
