        ...
        Button: {
            ...
            styles: (theme: any) =>
                ({
                    ...
                    filled: {
                        backgroundColor:
                            theme.colorScheme === 'dark' ? theme.colors.burgundy[5] : theme.colors.burgundy[6],
                        color: theme.colorScheme === 'dark' ? theme.colors.burgundy[0] : theme.colors.burgundy[0],
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[4] : theme.colors.burgundy[7],
                    ...
                    outline: {
                        ...
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[8] : theme.colors.burgundy[1],
                            borderColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[6] : theme.colors.burgundy[5],
                        },
                    },
                    subtle: {
                    ...
                    light: {
                        ...
                        '&:hover': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[7] : theme.colors.burgundy[2],
                        },
                    },
            ...
            styles: (theme: any) =>
                ({
                    ...
                    item: {
                        ...
                        '&[data-hovered]': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[7] : theme.colors.burgundy[1],
                            color: 'var(--mantine-color-text)',
                        },
                    },
                }) as Record<string, React.CSSProperties>,
                ...
                ({
                    radio: {
                        ...
                        '&:checked': {
                            backgroundColor: 'var(--mantine-color-body)',
                            borderColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[3] : theme.colors.burgundy[6],
                            '&::before': {
                                backgroundColor:
                                    theme.colorScheme === 'dark' ? theme.colors.burgundy[3] : theme.colors.burgundy[6],
                                width: '0.375rem',
            ...
            styles: (theme: any) =>
                ({
                    track: {
                        ...
                        '&[dataChecked]': {
                            backgroundColor:
                                theme.colorScheme === 'dark' ? theme.colors.burgundy[4] : theme.colors.burgundy[5],
                        },
                    },
                    thumb: {
        ...
        Table: {
            styles: (theme: any) =>
                ({
                    ...
                    thead: {
                        backgroundColor:
                            theme.colorScheme === 'dark' ? theme.colors.burgundy[8] : theme.colors.burgundy[0],
                    },
                    th: {
                        padding: '1rem',
                        fontSize: '0.875rem',
        ...
        Progress: {
            styles: (theme: any) =>
                ({
                    ...
                    bar: {
                        backgroundColor:
                            theme.colorScheme === 'dark' ? theme.colors.burgundy[4] : theme.colors.burgundy[6],
                        borderRadius: '9999px',
        ...
        Tooltip: {
            styles: (theme: any) =>
                ({
                    tooltip: {
                        backgroundColor:
                            theme.colorScheme === 'dark' ? theme.colors.burgundy[2] : theme.colors.burgundy[7],
