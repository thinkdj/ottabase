...
export function ModelCrud<T extends Record<string, unknown>>({
  ...
  const [selectedRecordId, setSelectedRecordId] = useState<string | number | null>(
  ...
  return (
    <div className={clsx("space-y-4", className)}>
      ...
      {/* Error Display */}
      {(listQuery.error || detailQuery.error || createMutation.error || updateMutation.error || deleteMutation.error) && (
        <ErrorBanner
          error={
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
          Are you sure you want to delete this {entityName.toLowerCase()} (ID: {recordId})? This action cannot be undone.
        </p>
