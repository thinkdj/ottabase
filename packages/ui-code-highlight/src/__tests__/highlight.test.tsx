...
const MockCodeHighlight = ({ code, language = 'javascript' }: { code: string; language?: string }) => (
    <pre>
...
describe('Code Highlighting', () => {
    describe('Code Rendering', () => {
        ...
        it('should support multiple languages', () => {
            const { container: jsContainer } = render(<MockCodeHighlight code="const x = 1;" language="javascript" />);
            const { container: pyContainer } = render(<MockCodeHighlight code="x = 1" language="python" />);

            expect(jsContainer.querySelector('[data-language="javascript"]')).toBeTruthy();
            expect(pyContainer.querySelector('[data-language="python"]')).toBeTruthy();
        });
  ...
  console.log("world");
    ...
    describe('Language Support', () => {
        it('should support JavaScript/TypeScript', () => {
            render(<MockCodeHighlight code="const x: string = 'test';" language="typescript" />);
        ...
        it('should support more languages', () => {
            ...
            languages.forEach((lang) => {
                const { container } = render(<MockCodeHighlight code="code" language={lang} />);
                expect(container.querySelector(`[data-language="${lang}"]`)).toBeTruthy();
            });
        });
    });
