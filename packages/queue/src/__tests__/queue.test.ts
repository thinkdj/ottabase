...
describe('Queue Package', () => {
    ...
    describe('Handler Registry', () => {
        ...
        it('should support chained registration', () => {
            ...
            registry.register('send-email', handler1).register('process-order', handler2);
        ...
        it('should list all registered types', () => {
            registry.register('type-a', vi.fn()).register('type-b', vi.fn()).register('type-c', vi.fn());
    ...
    describe('Deduplication', () => {
        ...
        it('should use custom TTL for deduplication', async () => {
            ...
            expect(mockDedupeStore.put).toHaveBeenCalledWith('dedupe:task:key-1', expect.any(String), {
                expirationTtl: 600,
            });
        });
    ...
    describe('Job Chaining', () => {
        ...
        it('should warn if chained jobs exist but no chainQueue configured', async () => {
            ...
            expect(consoleWarn).toHaveBeenCalledWith(expect.stringContaining('no chainQueue configured'));
    ...
    describe('Queue Processor', () => {
        ...
        it('should pass env to lifecycle hooks', async () => {
            ...
            expect(onAfterProcess).toHaveBeenCalledWith(expect.any(Object), env);
        });
    });
