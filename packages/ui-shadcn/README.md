...
Shared [shadcn/ui](https://ui.shadcn.com/) components and helpers used across Ottabase applications. The package provides:
...
1. Add "../../packages/ui-shadcn/components/\*_/_.{ts,tsx}" to the consuming app's <code>tailwind.config</code> content list.
