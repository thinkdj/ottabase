/**
 * Unit tests for `@ottabase/cf-pdf/client` — pure utility functions.
 *
 * DOM-dependent functions (captureDomAsHtml, downloadBlob, fetchAndDownloadPdf)
 * require a browser/JSDOM environment and are tested at the app level.
 * Here we test the pure helpers: sanitizeFileName and convertZoomToTransform.
 */
