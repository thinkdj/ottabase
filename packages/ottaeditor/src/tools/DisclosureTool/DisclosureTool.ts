...
export default class DisclosureTool implements BlockTool {
    ...
    constructor({ data, config, api }: BlockToolConstructorOptions<DisclosureData, DisclosureToolConfig>) {
        this.api = api;
        this.config = config || {};
    ...
    private buildAISection(): HTMLElement {
        ...
        const toggle = this.buildToggle('ai-enabled', this.data.aiEnabled, (checked) => {
        ...
        levelLabel.setAttribute('for', 'disclosure-ai-level');

        const levelSelect = document.createElement('select');
        levelSelect.id = 'disclosure-ai-level';
        ...
        percentLabel.setAttribute('for', 'disclosure-ai-percent');

        const percentInput = document.createElement('input');
        percentInput.id = 'disclosure-ai-percent';
    ...
    private buildSponsoredSection(): HTMLElement {
        ...
        const toggle = this.buildToggle('sponsored-enabled', this.data.sponsoredEnabled, (checked) => {
        ...
        customLabel.setAttribute('for', 'disclosure-sponsored-text');

        const customTextarea = document.createElement('textarea');
        customTextarea.id = 'disclosure-sponsored-text';
        ...
        radioTypes.forEach(({ value, label }) => {
            ...
            radio.type = 'radio';
            radio.name = 'disclosure-sponsored-type';
